...
\begin{frame}{Forward Process over Time}
	\begin{itemize}
		...
		\eqpause
		\vspace{-0.7cm}
		\item This process drives the data towards a stationary distribution as $t\!\to\!T$.
		\eqpause
		\item To achieve this behavior, we design the transition matrices $\bQ_t$ appropriately.
	\end{itemize}
\end{frame}
%=======
\begin{frame}{Designing the Transition Matrix $Q_t$}
	\myfootnotewithlink{https://arxiv.org/abs/2107.03006}{Austin J. et al. Structured denoising diffusion models in discrete state-spaces, 2021.}
	...
	\begin{itemize}
		...
		\[
			\bQ_t = (1 - \beta_t) \bI + \beta_t \mathbf{1} \mathbf{1}^\top.
		\]
